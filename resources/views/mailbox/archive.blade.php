        ...
        <div class="col-lg-9 animated fadeInRight">
            <div class="mail-box-header">
                ...
                <div class="mail-tools tooltip-demo m-t-md">
                    ...
                    <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="Mark as Archive"><i class="fa fa-archive"></i> </button>
                </div>
            </div>
...
<div class="mail-box">
    ...
    <tbody>
        @foreach ($archive as $archives)
            ...
            <td class="mail-ontact"><a href="/{{$archives->id}}">{{ $archives->title }}</a></td>
            <td class="mail-subject"><a href="/{{$archives->id}}">{{ $archives->body }}</a></td>
                <td class=""><i class="fa fa-paperclip"></i></td>
                <td class="text-right mail-date">{{ $archives->date }}</td>
            </tr>
        @endforeach
    <tr class="unread">
        <td class="check-mail">
