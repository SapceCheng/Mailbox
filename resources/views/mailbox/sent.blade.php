...
<div class="mail-box">
    ...
    <tbody>
        @foreach ($sents as $sent)
            ...
            <td class="mail-ontact"><a href="/sent/{{$sent->id}}">{{ $sent->title }}</a></td>
            <td class="mail-subject"><a href="/sent/{{$sent->id}}">{{ $sent->body }}</a></td>
                <td class=""><i class="fa fa-paperclip"></i></td>
                <td class="text-right mail-date">2020-02-20</td>
            </tr>
        @endforeach
    <tr class="unread">
        <td class="check-mail">
